...
> The **Navbar** tab of [Hub](/docs/fns-hub/) (the **FNS** button in the main-menu bar) manages what else lives on the pane bar: reorder items, flip an item between the left/right side, show/hide it, and drop any panel COMP on the FNS button to register it as its own self-installing navbar package.
