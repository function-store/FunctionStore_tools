...
You normally never touch it directly. Open the **Toolbar Configurator** (the
gear button on the bar) to reorder, group, hide/show and add dividers between
widgets; the layout is saved and follows you across projects through
...
script, no editing a definition table. Dragging any panel COMP onto the
Configurator's gear stamps that host into it for you, which is the quickest way
to put your own tool on the bar.
