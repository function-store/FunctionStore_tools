...
Sets the Input/Viewer Smoothness parameters found at the Common tab of selected TOP operators. Holding `Alt` while clicking an option from the dropdown will set it for all TOPs in your current network.
