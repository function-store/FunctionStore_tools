...
# Scrubs all host-registration state so the released OpMenuRegistry ships
...
# ('OpMenuRegistryExtStored'); legacy top-level keys scrubbed too.
for key in ('OpMenuRegistryExtStored', 'PaneRegistry', 'HostCanonical'):
